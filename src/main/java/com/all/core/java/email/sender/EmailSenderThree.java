...
public class EmailSenderThree {

	private static final Logger logger = Logger.getLogger(EmailSenderThree.class.getName());
	...
	private static void handleSendFailedException(SendFailedException e) {
		...
		if (invalidAddresses != null) {
			...
			for (Address address : invalidAddresses) {
				...
				if (address.toString().contains("554")) {
					System.err.println("   Reason: Message rejected with error code 554");
				}
			}
		}
		...
		if (nextException != null) {
			System.err.println("Additional Diagnostic Information: ");
