...
public class EmailSenderOne {

	private static final Logger logger = Logger.getLogger(EmailSenderOne.class.getName());
	...
	public static void main(String[] args) {
		...
		String mailTo = "anuragvasubharti@gmail.com";
	...
	private static void handleSendFailure(MessagingException e) {
