...
public class Voicent {
	...
	private static final Logger logger = Logger.getLogger(Voicent.class.getName());
	...
	/**
	 * Make a call to the number specified and play the text message using
	 ...
	 * @param selfdelete After the call, delete the call request automatically if
	 *                   set to 1
	...
	/**
	 * Make a call to the number specified and play the audio file. The audio file
	 * should be of PCM 8KHz, 16bit, mono.
	 *
	 * @param phoneno    Phone number to call, exactly as it should be dialed
	...
	public static void main(String args[]) throws InterruptedException {
		String mynumber = "9502119933"; // replace with your own
		...
		reqId = voicent.callAudio(mynumber, "D:/sample_message.wav", false);
		...
		voicent.callTillConfirm("C:/Program    Files/Voicent/BroadcastByPhone/bin/vcast.exe", "C:/temp/testctf.voc",
				"C:/Program Files/Voicent/MyRecordings/sample_message.wav", "1234");
	}
