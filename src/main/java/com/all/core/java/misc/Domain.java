...
public class Domain implements Comparable<Domain> {
	...
	public static void main(String[] args) {
		...
		String[] names = { "anil.dave@in.atlascopco.com", "anil.kumar@brainhunter.com", "anil.lanba@pyramidci.com",
				"anil.nr@marlabs.com", "anil.saldhana@redhat.com", "anil.tiwari@kiyaah.com", "anil@hrnetindia.com",
				"anil_khunte@rediff.com", "anil_redishetty@semanticspace.com", "anilb@spanidea.com",
				"anilesh.pillai@cabotsolutions.com", "anilkumar.m@synechron.com", "anilkumar_mca@outlook.com",
				"anjuanil@sify.com", "janiliya@srchist.info", "ranil@magna.in", "yusuf@vanilla-beans.in",
				"anil_nik@rediffmail.com", "anil_pune@rediffmail.com", "anilwpatil@rediffmail.com", };// StdIn.readAllStrings();
